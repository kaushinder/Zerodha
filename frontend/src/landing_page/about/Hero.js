...
function Hero() {
  return (
    <div className="container">
      ...
      <div className="row p-5 mt-5 border-top text-muted fs-6 " style={{ lineHeight: "1.8", fontSize: "1.1rem" }}>
        ...
        <div className="col-6 p-5">
          ...
          <p>
            <a href="h" style={{ textDecoration: "none" }}>
              Rainmatter
            </a>, our fintech fund and incubator, has
